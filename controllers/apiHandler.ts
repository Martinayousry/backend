...
import { filterData } from './subCategory';

export const createOneDocument = <modelType>(model: mongoose.Model<any>) => asyncHandler(async (req: Request, res: Response, next: NextFunction): Promise<void> => {
